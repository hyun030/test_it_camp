    ...
    <div class="card analysis-card">
        ...
        <div class="card-content">
            <p class="card-description">
                ...
                <span class="highlight">'LLM 경량화'</span>와 <span class="highlight">'온디바이스 AI'</span> 경험입니다. 
...
# --- 메인 로직 ---
# st.set_page_config과 CSS 로드는 스크립트 최상단에서 한 번만 실행되어야 합니다.
# 헤더를 먼저 그리고, 현재 페이지 상태에 따라 다른 콘텐츠를 그립니다.
